...
import EditSplit from "./EditSplit.vue";
...
const loadItems = async ({ page, itemsPerPage, sortBy, search }) => {
    ...
    try {
        const response = await axios.get(route("coPaymentUser.fetchData"), {
            params: {
                page,
                itemsPerPage,
                sortBy: sortBy[0]?.key,
